 ...
 * @method static \Netflex\Query\Builder andWhere(string $field, string $operator, mixed $value)
 ...
 * @method static \Netflex\Query\Builder orWhere(string $field, string $operator, mixed $value)
 ...
 * @method static \Netflex\Query\Builder where(string $field, string $operator, mixed $value)
 * @method static \Netflex\Query\Builder whereNot(string $field, string $operator, mixed $value)
